...
contract Demy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(Marketing Wallet); // Marketing Address
    ...
    string private _name = "Demy";
    string private _symbol = "Demy";
